...
const MODES = [
  ...
  { id: 'guided', label: 'Guided endings', help: 'Add the endings with on-screen hints.', comp: GuidedEndings },
  { id: 'blind', label: 'Type the endings', help: 'Type every ending with no help.', comp: BlindEndings },
]
