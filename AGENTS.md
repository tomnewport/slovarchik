...
src/
  ...
  router/index.js       # 19 routes → views. Highlights: / (home), /session, /batch,
                        #   /progress, /data, /vocab, /phrases, /phrase-fix,
                        #   /verb-government, /listening, /speaking, /numbers, /bomb,
                        #   /crush, /firewatch, /maze, and the shared inflection view at
  ...
  views/*.vue           # one screen per route (HomeView + SessionView are the big ones;
                        ...
                        #   MeaningMazeView are the minigames — #726's between-practice
